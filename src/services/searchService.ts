...
export class SearchService {
  ...
  public async deleteByQuery(cacheName: string, query: string): Promise<Either<ActionResponse, DeleteByQueryResult>> {
    const url = this.endpoint + encodeURIComponent(cacheName) + '/_delete-by-query';
    const body = JSON.stringify({
      query: query
    });
    // @ts-ignore
  ...
  public async retrieveStats(cacheName: string): Promise<Either<ActionResponse, SearchStats>> {
    return this.utils.get(this.endpoint + encodeURIComponent(cacheName) + '/_search-stats', (data) => {
  ...
  public async retrieveIndexMetamodel(cacheName: string): Promise<Either<ActionResponse, Map<string, IndexMetamodel>>> {
    return this.utils.get(this.endpoint + encodeURIComponent(cacheName) + '/_index-metamodel', (data) => {
  ...
  public async updateSchema(cacheName: string): Promise<ActionResponse> {
    return this.utils.post({
      url: this.endpoint + encodeURIComponent(cacheName) + '/_index-schema-update',
  ...
  public async reindex(cacheName: string): Promise<ActionResponse> {
    return this.utils.post({
      url: this.endpoint + encodeURIComponent(cacheName) + '/_reindex?mode=async',
  ...
  public async clearQueryStats(cacheName: string): Promise<ActionResponse> {
    return this.utils.post({
      url: this.endpoint + encodeURIComponent(cacheName) + '/_search-stats-clear',
