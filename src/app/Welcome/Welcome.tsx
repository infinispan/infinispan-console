...
const Welcome: React.FunctionComponent<any> = (props) => {
  ...
  const description1 = 'Infinispan is a distributed in-memory key/value data store with optional schema, available under the Apache License 2.0. ' +
  ...
  const description2 = 'Use it as a cache or a data grid. Works on bare-metal, containerized and virtualized environments. ' +
    ...
    <Page>
      ...
      >
        <Stack gutter={"md"}>
          ...
          <StackItem><Button href={utils.endpoint() + '/login?action=login'} component="a">Go to the console</Button></StackItem>
        </Stack>
      </LoginPage>
    </Page>
  );
