                ...
                <Tbody>
                  {filteredConnections.length == 0 ? (
                    ...
                    rows.map((row) => {
                      return (
                        <Tr key={row.id}>
                          <Td dataLabel={columnNames.name}>{row['server-node-name']}</Td>
                          ...
                          <Td dataLabel={'tooltip'}>{displayMoreInfo(row)}</Td>
                        </Tr>
                      );
                    })
                  )}
