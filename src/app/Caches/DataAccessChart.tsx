        ...
        <div style={{ width: '100%', height: '480px' }}>
          <ChartDonut data-cy='data-access-chart'
            ...
            legendData={[
              ...
              {
                name:
                  t('caches.cache-metrics.data-access-misses') + ': ' + displayUtils.formatNumber(props.stats.misses)
              },
              {
                name:
                  t('caches.cache-metrics.data-access-stores') + ': ' + displayUtils.formatNumber(props.stats.stores)
              },
              {
                name:
