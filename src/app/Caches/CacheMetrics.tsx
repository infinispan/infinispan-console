...
const CacheMetrics = (props: { cacheName: string; display: boolean }) => {
  ...
  useEffect(() => {
    ...
    if (loadMemory[cacheMode].memory) {
      if (
        loadMemory[cacheMode].memory.storage === 'HEAP' &&
        loadMemory[cacheMode].memory['max-size']
      )
      ...
      <Card>
        ...
        <CardBody>
          <TextContent>
            <TextList component={TextListVariants.dl}>
              <TextListItem
                aria-label="view-cache-approximate-unique-entries"
              ...
              <TextListItem component={TextListItemVariants.dd}>
                <PopoverHelp
                  ...
                  content={t(
                    'caches.cache-metrics.approximate-unique-entries-tooltip'
                  )}
                  text={t('caches.cache-metrics.approximate-unique-entries')}
                />
              </TextListItem>
              <TextListItem
                aria-label="view-cache-approximate-entries-in-memory"
                component={TextListItemVariants.dt}
              >
              ...
              <TextListItem component={TextListItemVariants.dd}>
                <PopoverHelp
                  name="min-nodes"
                  label={t(
                    'caches.cache-metrics.approximate-entries-in-memory'
                  )}
                  content={t(
                    'caches.cache-metrics.approximate-entries-in-memory-tooltip'
                  )}
                  text={t('caches.cache-metrics.approximate-entries-in-memory')}
                />
              </TextListItem>
              <TextListItem
                aria-label="view-cache-approximate-entries"
                component={TextListItemVariants.dt}
              >
              ...
              <TextListItem component={TextListItemVariants.dd}>
                <PopoverHelp
                  ...
                  content={t(
                    'caches.cache-metrics.approximate-entries-tooltip'
                  )}
  ...
  const buildMemoryCard = () => {
    ...
    if (memory === StorageType.OFF_HEAP) {
      content = (
        <React.Fragment>
          <TextListItem
            aria-label="view-cache-metrics-off-heap"
            component={TextListItemVariants.dt}
          >
      ...
      content = (
        <React.Fragment>
          <TextListItem
            aria-label="view-cache-metrics-heap"
            component={TextListItemVariants.dt}
          >
        ...
        <CardBody>
          <TextContent>
            <TextList component={TextListVariants.dl}>
              {content}
              <TextListItem
                aria-label="view-cache-metrics-nodes"
                component={TextListItemVariants.dt}
              >
