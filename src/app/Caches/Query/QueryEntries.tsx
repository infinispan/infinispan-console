...
import { ExternalLinkSquareAltIcon, PencilAltIcon, SearchIcon, TrashIcon } from '@patternfly/react-icons';
            ...
            <Flex direction={{ default: 'column' }} spaceItems={{ default: 'spaceItemsXs' }}>
              ...
              <FlexItem>
                <Button
                  ...
                  icon={<PencilAltIcon />}
                  isDisabled={search.query.trim().length == 0 || !search.query.toLowerCase().startsWith('update')}
                  size={'sm'}
                >
