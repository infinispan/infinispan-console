...
import { useDeleteByQuery } from '@app/hooks/searchHook';
...
const DeleteByQueryEntries = (props: {
  ...
  const { setExecute } = useDeleteByQuery(
    props.cacheName,
    props.query,
    props.closeModal,
  );
  ...
  return (
    ...
    >
      <ModalHeader
        ...
        title={t('caches.query.modal-delete-entries-title')}
      />
      <ModalBody>
        <Content component={'p'}>
        ...
        <Content component={'p'}>
          {t('caches.query.modal-delete-entries-body-line-two')}
        </Content>
      </ModalBody>
      <ModalFooter>
        <Button
