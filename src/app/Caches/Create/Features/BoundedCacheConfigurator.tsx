...
const BoundedCacheConfigurator = () => {
  ...
  return (
        <FeatureCard title={'caches.create.configurations.feature.bounded'} description={'caches.create.configurations.feature.bounded-tooltip'}>
          <Grid hasGutter md={6}>
            <GridItem span={12}>
            <FormGroup
              isInline
          ...
          {evictionType === 'size' &&
            ...
            >
              <InputGroup>
                <TextInput data-cy='memorySizeInput'
                           validated={validateBoundedValue('size')}
                           min={0} value={maxSize}
                           type="number"
