...
const TransactionalCacheConfigurator = (props: {
    ...
    if (!props.isEnabled) {
      return (
          <FeatureAlert feature={CacheFeature.TRANSACTIONAL}/>
      )
    }

    return (
            <FeatureCard title="caches.create.configurations.feature.transactional" description="caches.create.configurations.feature.transactional-description">
                <FormGroup fieldId='form-transaction-mode'
                ...
                >
                  <Radio
                    ...
                    label={<PopoverHelp name={'non-durable-xa'}
                ...
                >
                  <Radio
                    ...
                    label={<PopoverHelp name={'optimistic'}
                                        ...
                                        content={t('caches.create.configurations.feature.locking-mode-optimistic-tooltip', { brandname: brandname })}/>}
                  />
                  <Radio
                    name="radio-locking"
                    id="pessimistic"
                    ...
                    label={<PopoverHelp name={'pesimistic'}
                                        ...
                                        content={t('caches.create.configurations.feature.locking-mode-pessimistic-tooltip', { brandname: brandname })}/>}
                  />
                </FormGroup>
            </FeatureCard>
    );
