...
import TransactionalConfigurationTuning
  from '@app/Caches/Create/AdvancedTuning/TransactionalConfigurationTuning';
...
const AdvancedOptionsConfigurator = () => {
    ...
    const [lockAcquisitionTimeout, setLockAcquisitionTimeout] = useState<number | undefined>(configuration.advanced.lockAcquisitionTimeout);
    ...
    const formMemory = () => {
      return (
        <FormGroup
          ...
          labelIcon={<PopoverHelp name="storage"
                                  label={t('caches.create.configurations.advanced-options.storage-title')}
          ...
          <FormSection title={t('caches.create.configurations.advanced-options.locking-title')}>
            ...
            <Grid hasGutter md={4}>
              <FormGroup
                ...
                labelIcon={<PopoverHelp name="concurrency-level" label={t('caches.create.configurations.advanced-options.concurrency-level-title')} content={t('caches.create.configurations.advanced-options.concurrency-level-tooltip')} />}
              >
              ...
              <FormGroup
                ...
                labelIcon={<PopoverHelp name="lock-acquisition-timeout"
                                        label={t('caches.create.configurations.advanced-options.lock-acquisition-timeout-title')}
