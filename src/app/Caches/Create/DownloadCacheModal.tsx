...
const DownloadCacheModal = (props: {
  ...
  const contentTypeToDownloadType = (ct: 'json' | 'yaml' | 'xml'): ConfigDownloadType => {
    switch (ct) {
      case 'yaml':
  ...
  const [downloadLanguage, setDownloadLanguage] = useState(contentTypeToDownloadType(props.contentType));
