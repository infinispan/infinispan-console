  ...
  const buildStatus = (site: string, status: string) => {
    ...
    return (
      <Switch
        ...
        label={
          status == 'online'
            ? t('caches.backups.take-offline-action')
            : t('caches.backups.bring-online-action')
        }
          ...
          <Tr>
            <Td colSpan={4}>
              <Bullseye>
                ...
                >
                  <EmptyStateBody>
                    {t('caches.backups.no-backups-body')}
                  </EmptyStateBody>
                </EmptyState>
              </Bullseye>
            </Td>
          ...
          return (
            <Tr key={backup.name}>
              ...
              <Td dataLabel={columns[2].title}>
                {buildStateTransferStatus(backup.name)}
              </Td>
              <Td dataLabel={columns[3].title}>
                {buildStateTransferButton(backup)}
              </Td>
            </Tr>
          );
        })}
  ...
  return (
    <React.Fragment>
      <DataContainerBreadcrumb
        currentPage={t('caches.backups.title')}
        cacheName={cacheName}
      />
