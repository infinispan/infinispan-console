...
const ClusterDistribution = () => {
    ...
    const onSelectStatsOptions = (event, selection, isPlaceholder) => {
      if (
        ...
        selection === t('global-stats.cluster-distribution-option-memory-used')
      )
    ...
    const buildCardContent = () => {
      ...
      const columnNames = {
        ...
        memoryAvailable: t(
          'global-stats.cluster-distribution-option-memory-used'
        ),
        memoryUsed: t(
      ...
      return size < 5 ? clusterChart : clusterTable;
    };
