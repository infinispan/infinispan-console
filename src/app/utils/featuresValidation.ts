...
export function validFeatures(configuration: CacheConfiguration) : boolean {
  return  validateFeature(CacheFeature.BOUNDED, 'boundedCache', configuration)
...
function validateFeature(feature: CacheFeature,
                                 property:string,
                                 configuration: CacheConfiguration) : boolean {
