...
describe('Display Utils tests', () => {
  test('parseStateTransferStatus', () => {
    ...
    expect(displayUtils.parseStateTransferStatus('CANCELED')).toBe(
      ST_SEND_CANCELED
    );
  ...
  test('parseComponentStatus', () => {
    ...
    expect(displayUtils.parseComponentStatus('TERMINATED')).toBe(
      TERMINATED_STATUS
    );
    expect(displayUtils.parseComponentStatus('INSTANTIATED')).toBe(
      INSTANTIATED_STATUS
    );
  });
