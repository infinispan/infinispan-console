describe('Query History', () => {
  ...
  it('successfully records an update query in history', () => {
    ...
    cy.get('[data-cy=manageEntriesTab]').click();
    cy.get('[data-cy=queriesTab]').click();
    cy.typeInMonacoEditor('#textSearchByQuery', "update from org.infinispan.Person set city = 'Barcelona' where name = 'HistoryTest'");
    ...
    cy.get('[data-cy=queryHistoryTable]').should('exist');
    cy.contains('update from org.infinispan.Person');
    cy.contains('Update');
  });
